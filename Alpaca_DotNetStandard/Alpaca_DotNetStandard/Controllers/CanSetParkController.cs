...
namespace Alpaca_Telescope_DotNetStandard.Controllers
{
    ...
    public class cansetparkController : ApiController
    {
        ...
        public BoolResponse Get(int ClientID, int ClientTransactionID)
        {
            try
            {
                bool CanSetPark = MyGlobals.Telescope.CanSetPark;
                //MyGlobals.Telescope.TraceLogger.LogMessage(methodName + " Get", CanSetPark.ToString());
