...
namespace Alpaca_Telescope_DotNetStandard.Controllers
{
  //[Route("api/v1/telescope/{device_number}/[controller]")]
    ...
    public class canpulseguideController : ApiController
    {
        ...
        public BoolResponse Get(int ClientID, int ClientTransactionID)
        {
            try
            {
                bool CanPulseGuide = MyGlobals.Telescope.CanPulseGuide;
                //MyGlobals.Telescope.TraceLogger.LogMessage(methodName + " Get", CanPulseGuide.ToString());
